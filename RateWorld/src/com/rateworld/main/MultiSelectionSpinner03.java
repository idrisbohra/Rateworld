...
public class MultiSelectionSpinner03 extends Spinner implements
    ...
    public MultiSelectionSpinner03(Context context) {
        super(context);
    ...
    public MultiSelectionSpinner03(Context context, AttributeSet attrs) {
        super(context, attrs);
