...
public class OfflineServiceActivity extends Service {
	...
	public void onStart(Intent intent, int startId) {
		...
		.setContentText("Check out currency rate")
        ...
        .bigText(stringCategory+"\nToday's rates are outdated because of no internet connection.").build();
